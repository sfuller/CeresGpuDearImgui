...
namespace CeresGpuDearImgui.Backend
{
    ...
    public sealed class CeresGpuImguiHelper : IDisposable
    {
        ...
        public CeresGpuImguiHelper(IRenderer renderer, GLFWWindow window, ShaderManager shaderManager, ISampler textureSampler, ReadOnlySpan<Type> compatiblePassTypes)
        {
            ...
            _imguiRenderer = new ImGuiRenderer(renderer, shaderManager, textureSampler, compatiblePassTypes);
